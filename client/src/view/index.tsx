...
const AppRoot = () => {
    ...
    return <div className='overflow-x-hidden'>
            ...
            <div className="px-6 py-24 sm:px-24 bg-primary shadow-lg">
                <Section img="./view/public/chrono_code.png" alt="Coding chrono" right={true} id="aboutme" title="About Me" desc={[
            ...
            <div className="px-6 py-24 sm:px-24 bg-secondary shadow-lg">
                <Section img="./view/public/chrono_packages.png" alt="Chrono carries packages" right={false} id="prologue" title="How I Started" desc={[
            ...
            <div className="px-6 py-24 sm:px-24 bg-primary shadow-lg">
                <Section img="./view/public/chrono_work.png" alt="Chrono at work" right={true} id="doing" title="Currently Working on..." desc={[
            ...
            <div className="px-6 py-24 sm:px-24 bg-secondary shadow-lg">
                <Section img="./view/public/chrono_git.png" alt="Chrono managing version control" right={false} id="plans" title="Planning on..." desc={[
            ...
            <div  className="px-6 py-24 sm:px-24 bg-secondary shadow-lg">
                <Section img="./view/public/chrono_contacts.png" alt="Chrono holding a letter" right={true} id="contacts" title="Want to reach me out?" desc={[
